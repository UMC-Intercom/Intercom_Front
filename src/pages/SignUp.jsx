    ...
    <SignUpContainer>
      <SignUpForm>
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td>
                ...
                {isEmailCheck !== null && (
                  <img
                    src={isEmailCheck ? 'assets/Check2.png' : 'assets/UnChecked.png'}
                    alt="이메일 중복 확인"
          ...
          <img
            className='check'
            src={isEmailCheck ? 'assets/Check2.png' : 'assets/UnChecked.png'} // 변경필요
            alt="이메일 중복 확인"
        ...
        <br />
        <button type='submit'> 
          <img src='assets/TemporarySignUpButton.png' />
        </button>
      </SignUpForm>
    </SignUpContainer>
  );
