...
const DownloadCompleteModal = ({ onClose }) => (
  <ModalBackground>
    <ModalContainer>
      <ModalCloseButton src="./assets/closebtn.png" alt="Close" onClick={onClose} />
      <ModalTitle>다운로드 되었습니다<br></br>파일을 확인해주세요</ModalTitle>
      <ModalButtonContainer>
        <ModalPDFButton onClick={onClose}>확인</ModalPDFButton>
      </ModalButtonContainer>
    </ModalContainer>
  </ModalBackground>
);
  return (
    <>
      ...
      {showDownloadCompleteModal && <DownloadCompleteModal onClose={handleModalCloseAndNavigate}/>}
    <MainContainer ref={contentRef} >
      ...
      <ContentContainer>
        {!isPdfDownloadMode && <DeactivatePDF />}
